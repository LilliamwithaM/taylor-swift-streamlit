...
sidebar = st.sidebar
sidebar.image("the_eras_tour_logo.png")
sidebar.title("Lilliam Romero Reyes")
sidebar.write("Matricula: S20006765")
sidebar.write("zs20006765@estudiantes.uv.mx")
sidebar.image("eras.png")
